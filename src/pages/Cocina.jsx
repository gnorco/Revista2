...
export default function CocinaSection() {
  ...
  return (
    <section className="bg-gray-50 py-16 px-4 text-gray-800 w-full">
      <div className="w-full mx-auto text-center space-y-12">
        ...
        <div className="space-y-6">
          ...
          <p className="text-lg md:text-xl max-w-3xl mx-auto">
            La gastronomía ha evolucionado desde la recolección y caza prehistórica hasta convertirse en un arte
            culinario reconocido. La tecnología se integró para mejorar técnicas y crear experiencias únicas, como la
            impresión 3D de alimentos y la cocina molecular.
          </p>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-wrap justify-center gap-8">
            {chefs.map((c, i) => (
              <div
                key={i}
                className="flex flex-col items-center bg-white rounded-xl shadow-md p-4 hover:scale-105 transition transform"
              >
        ...
        <div className="space-y-2">
          <p className="text-lg md:text-xl font-semibold">
            La cocina no solo es sabor, sino también ciencia, tecnología e innovación. Cada técnica y cada chef muestran
            cómo los alimentos pueden convertirse en experiencias únicas.
          </p>
        </div>
